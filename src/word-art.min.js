...
$(document).ready(function(){var a=$("#word_art_form"),c=$("#display_results"),b=$("#display_loading"),e="Dope!;Sick!;Wow!;Really nice work -;Incredible!!!;That's tight -;Wicked sick!;My friend, you have astonished me.;Could it be? YES!;Honestly, I'm impressed -;Superlative!;Can you believe it?;Outstanding!;[Generic Positive Expression]!;I can tell you are smart -".split(";"),f=function(){b.html("").hide();c.show();a.show()},p=function(a){return'\x3cp class\x3d"text-danger"\x3eThere was an svg_error generating your SVG file: \n    \x3cstrong\x3e'+
